...
<div id="wrapper">
	...
	<form action="<?php echo /*removed quotations from this*/ URL_ROOT . '/add_products_to_inventory.php' ?>" method="post">
	...
	}//Deleted the ) and replaced it with the ending bracket. This allowed to first display the form.
	?>
